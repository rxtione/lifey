    ...
    value: function _resolveBucketEndpoint(bucketID) {
      ...
      if (!this._endpoints.has(bucketID)) {
        var promise = this._axios.request({
          ...
          _this._endpoints.delete(bucketID);
          throw e;
        });
